...
const StatsCard: React.FC<StatsCardProps> = ({ title, value, icon: Icon, trend, color = 'green' }) => {
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-4 lg:p-6 hover:shadow-lg transition-all duration-200 transform hover:scale-[1.02]">
      <div className="flex items-center justify-between">
        ...
        <div className={`p-2 lg:p-3 rounded-lg ${colorClasses[color]} transition-transform duration-200 hover:scale-110`}>
